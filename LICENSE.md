Copyright © 2026 Persistant Studios, SARL.

Licensed under the PopcornFX Community License for PopcornFX-dependent projects See PopcornFX Community License. https://www.popcornfx.com/popcornfx-community-license

Unless expressly provided otherwise, the Software under this license is made available strictly on an “AS IS” BASIS WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED. Please review the license for details on these and other terms and conditions. https://www.popcornfx.com/terms-and-conditions
PopcornFX Community License (“License”)
...
The LICENSEE will ONLY use delivered content into one of those Game Engines (Unreal Engine, Unity, Godot, O3DE, After Effects)
...
LICENSEE explicitly agree that for Unreal Engine, Unity, Godot, O3DE, and After Effects plugins :
...
Final assets : Assets you have created in the final development tool are your property and can be sold on any store (please refer to the EULA of each store). If you allow PERSISTANT STUDIOS to use this content as communication content, please email contact@popcornfx.com
...
6.3 LICENSEE'S RIGHT TO USE DERIVATIVE WORKS
...
The PopcornFX logo shall be displayed in the title screen (or splash screen) and in the credits of the Game, along with the text : “Particle VFX powered by PopcornFX - © 2022 Persistant Studios”
...
See the (“Community License”) [here](https://www.popcornfx.com/popcornfx- community-license).
